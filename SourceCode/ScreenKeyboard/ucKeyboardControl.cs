...
{
    public partial class UcKeyboardControl : UserControl
    {
        public UcKeyboardControl()
        {
            InitializeComponent();
        }
        ...
        private KeyBoardTypeEnum _pvtKeyboardType = KeyBoardTypeEnum.Standard;

        public KeyBoardTypeEnum KeyboardType
        {
            get
            {
            ...
            set
            {
                ...
                if (_pvtKeyboardType == KeyBoardTypeEnum.Standard)
                {
                    pictureBoxKeyboard.Image = ScreenKeyboardControl.Properties.Resources.keyboard_white;
                    pictureBoxCapsLockDown.Image = ScreenKeyboardControl.Properties.Resources.caps_down_white;
                    pictureBoxLeftShiftDown.Image = ScreenKeyboardControl.Properties.Resources.shift_down_white;
                    pictureBoxRightShiftDown.Image = ScreenKeyboardControl.Properties.Resources.shift_down_white;
                }
                else if (_pvtKeyboardType == KeyBoardTypeEnum.Alphabetical)
                {
                    pictureBoxKeyboard.Image = ScreenKeyboardControl.Properties.Resources.keyboard_alphabetical;
                    pictureBoxCapsLockDown.Image = ScreenKeyboardControl.Properties.Resources.caps_down_white;
                    pictureBoxLeftShiftDown.Image = ScreenKeyboardControl.Properties.Resources.shift_down_white;
                    pictureBoxRightShiftDown.Image = ScreenKeyboardControl.Properties.Resources.shift_down_white;
                }
                ...
                {
                    pictureBoxKeyboard.Image = ScreenKeyboardControl.Properties.Resources.keyboard_kids_lower;
                }
            }
        }

        [Category("Mouse"), Description("return value of mouse clicked key")]
        ...
        private void pictureBoxKeyboard_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (_pvtKeyboardType == KeyBoardTypeEnum.Kids)
            {
                _pvtKeyboardKeypressed = HandleKidsMouseClick(xpos, ypos);
            }
            else
            {
                _pvtKeyboardKeypressed = HandleTheMouseClick(xpos, ypos);
            }
        ...
        private void HandleCapsLock()
        {
            ...
            else
            {
                ...
                if (_pvtKeyboardType == KeyBoardTypeEnum.Kids)
                {
                    pictureBoxKeyboard.Image = ScreenKeyboardControl.Properties.Resources.keyboard_kids_upper;
                }
        ...
        private void pictureBoxLeftShiftDown_MouseClick(object sender, MouseEventArgs e)
        {
            HandleShiftClick();
        }

        private void pictureBoxRightShiftDown_MouseClick(object sender, MouseEventArgs e)
        {
            HandleShiftClick();
        }

        private void pictureBoxCapsLockDown_MouseClick(object sender, MouseEventArgs e)
        {
            HandleCapsLock();
        }
    }
    ...
    public class KeyboardEventArgs : EventArgs
    {
        ...
        public KeyboardEventArgs(string pvtKeyboardKeyPressed)
        {
    ...
    [Category("Keyboard Type"), Description("Choose type of keyboard to use.")]
